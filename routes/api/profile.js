//adding profile or updating them
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      const profile = await Profile.findOne({ user: req.user.id }); //get the profile by user id
      ...
      console.error(err.message);
      res.status.send(400).send('Server Error');
    }
  }
);

//@route   DELETE api/profile/experience/:exp_id
//@desc    Delete experience from pfofile
//@access  Private
...
//@desc    Delete education from pfofile
//@access  Private
